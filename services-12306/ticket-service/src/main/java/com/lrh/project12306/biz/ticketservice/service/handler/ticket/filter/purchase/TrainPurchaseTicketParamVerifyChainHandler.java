...
import com.lrh.project12306.biz.ticketservice.common.constant.Index12306Constant;
...
import static com.lrh.project12306.biz.ticketservice.common.constant.RedisKeyConstant.TRAIN_STATION_STOPOVER_DETAIL;


/**
 * @ProjectName: project-12306
 * @Package: com.lrh.project12306.biz.ticketservice.service.handler.ticket.filter.purchase
 * @ClassName: TrainPurchaseTicketParamVerifyChainHandler
 * @Author: 63283
 * @Description: 购票流程过滤器之验证参数是否有效 验证参数有效这个流程会大量交互缓存，为了优化性能需要使用 Lua。为了方便大家理解流程，这里使用多次调用缓存
