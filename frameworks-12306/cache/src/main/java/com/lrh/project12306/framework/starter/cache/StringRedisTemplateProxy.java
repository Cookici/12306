...
import com.lrh.project12306.framework.starter.cache.core.CacheGetFilter;
import com.lrh.project12306.framework.starter.cache.core.CacheGetIfAbsent;
...
import com.lrh.project12306.framework.starter.cache.toolkit.FastJson2Util;
 ...
 * @Package: com.lrh.project12306.framework.starter.cache
 * @ClassName: StringRedisTemplateProxy
 * @Author: 63283
 * @Description: 分布式缓存之操作 Redis 模版代理 底层通过 RedissonClient、StringRedisTemplate 完成外观接口行为
 * @Date: 2024/3/6 16:00
 */
