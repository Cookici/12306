 ...
 * @ClassName: Snowflake
 * @Author: 63283
 * @Description: Twitter的Snowflake 算法 分布式系统中，有一些需要使用全局唯一ID的场景，有些时候我们希望能使用一种简单一些的ID，并且希望ID能够按照时间有序生成。
 ...
 * 参考：h<a href="ttp://www.cnblogs.com/relucent/p/4955340.html"></a>关于长度是18还是19的问题见：https://blog.csdn.net/unifirst/article/details/80408050
 * 自:
 * 3.0.1
 * 作者:
 * Looly
